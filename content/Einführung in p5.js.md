...
Wer hat schonmal was gemacht?
Was hat euch vielleicht auch davon abgehalten?

## Was ich euch zeigen möchte

- Einen Überblick über das Feld schaffen
- Warum programmieren Spaß macht
- Was man / was wir damit machen können

## Creative Coding

- Technisches Programmieren als kreative Praxis verstehen
- Embrace the Process
- Auseinandersetzung mit Technologien

- Mit verschiedenen Programmiersprachen und Programmen
...
- Nachgänger von Processing (Java)

- Weiterhin von der Processing Foundation

- Jetzt über JavaScript

- Web-basiert, im Browser

- Dadurch wesentlich zugänglicher

- Kompatibel mit anderen JavaScript Bibliotheken (d3.js, ml5.js)

- p5.js-Editor = Die eigene web-basierte Entwicklungsumgebung

- Für größere Projekte unbedingt in VS-Code o.ä. arbeiten
 


## Übung 1: Der Editor und grundlegende p5.js-Funktionen

[Editor](https://editor.p5js.org/MaxRodenkirchen/sketches/3p51ODyP_)

Wie ist der Editor aufgebaut und wie funktioniert p5.js
- Setup
- Draw 
- Canvas
- Dateistruktur

- Shape mit (mouseX und mouseY)

Wir erstellen SVGs nach einer Sortierung und laden sie in die Bildrasterung
- Koordinatensystem
- Form erstellen
- Farben 

- [Bildrasterung von Linda](https://editor.p5js.org/infovisAA/sketches/eNDSPuX3y)
- [Bildrasterung mit Motiv](https://editor.p5js.org/MaxRodenkirchen/full/SvzL0yFP2)

## Aufgabe: Komplexere Form

Formen für den L-Tree erstellen

- [L-Tree - KI-Übersetzung](https://editor.p5js.org/MaxRodenkirchen/full/r7Uk1zHQN)
...
The Coding Train: Lustige YouTube Tutorials von Daniel Shiffman
https://thecodingtrain.com/

The Nature of Code von Daniel Shiffman
