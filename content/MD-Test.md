...
p5.js is a JavaScript library. It makes coding accessible for artists and designers. It is great for web-based sketches -> it runs directly in the browser!

#### TouchDesigner

TouchDesigner is a node-based visual programming environment. It is often used for:
- Projection Mapping
- Interactive Installations
- Real-time Audio Visuals

Here is an example of capturing movement in TouchDesigner:

![[capturingMovementWebcam_Touchdesigner.png]]

## Hybrid Search & Alternative Interfaces
...
###### Final Thoughts
This document combines different elements: headings (h1 to h6), lists, internal wiki-links, external links, images, iframes, and the custom arrow syntax (->).
